...
def load_data(split, target_gender, allow_ambiguous_instances=False, count=None, automatic_bag_of_words=None, automatic_bag_of_words_split=None, automatic_bag_of_words_model=None, automatic_bag_of_words_length=None):
    ...
    if automatic_bag_of_words == "contrastive":
        ...
        _, male_texts = _load_texts(automatic_bag_of_words_split, "M", allow_ambiguous_instances, count)
        _, female_texts = _load_texts(automatic_bag_of_words_split, "F", allow_ambiguous_instances, count)
...
if __name__ == "__main__":
    # examples
    source_texts, target_texts, positive_bag_of_words, negative_bag_of_words = load_data("test", "F", allow_ambiguous_instances=False, count=None)
